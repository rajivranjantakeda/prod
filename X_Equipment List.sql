...
SELECT  [ROW_ID]
      ...
      ,[R_Abbr__Doc__Name_]
      ,[U_Document_Link___Attachment]
      ,[R_Document_Link___Attachment] FROM [StatureProdQbD].[dbo].[X_Equip List_Site_publish_new] where U_Unit_Operation is not null
union
SELECT  [ROW_ID]
      ,[VERSION_ID]
      ,[REVISION_ID]
      ...
      ,[R_Abbr__Doc__Name_]
      ,[U_Document_Link___Attachment]
      ,[R_Document_Link___Attachment] FROM [StatureProdQbD].[dbo].[X_Equip List_Site_draft_new] where U_Unit_Operation is not null
GO
